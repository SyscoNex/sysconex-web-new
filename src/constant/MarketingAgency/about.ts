...
const aboutData: IAboutData = {
  ...
  title:
    "Sysconex believes in the power of creativity to ignite growth. We aim to empower businesses to unlock their full potential by delivering cutting-edge marketing solutions that drive results.",
